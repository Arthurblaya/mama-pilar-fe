export default function Home() {
  return (
    <div className="m-4 mt-8 flex min-h-screen flex-col items-center justify-start bg-base-100 sm:justify-center sm:mt-4">
      <div className="prose">
        ...
        <button className="btn btn-primary mt-4">Descobreix</button>
      </div>
    </div>
  );
}
